#!/usr/bin/env python3
"""Demo 14 — OAT sensitivity plot (drained lateral boundary).

Three columns, one per sweep (phi | alpha | perm).
Rows: pressure (log y) | uz_at_bottom | load track.
...
# ── Suptitle ──────────────────────────────────────────────────────────────────
fig.suptitle(
    "Demo 14 — OAT Sensitivity, drained lateral boundary (right: P=0, free)  |  "
