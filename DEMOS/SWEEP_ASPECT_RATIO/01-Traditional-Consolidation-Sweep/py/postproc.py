#!/usr/bin/env python3
"""Aspect-ratio sweep — Traditional Consolidation (laterally drained) — plots.
...
ax_p.set_title("AR sweep — Traditional (laterally drained)  |  "
...
fig2.suptitle("AR sweep — Traditional (laterally drained)  |  final-state errors vs Terzaghi 1D",
              fontsize=9)
fig2.tight_layout()
