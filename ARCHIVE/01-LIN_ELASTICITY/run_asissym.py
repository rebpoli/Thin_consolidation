...
facets = mesh_data.facet_tags  # This is what you need
cell_tags = mesh_data.cell_tags  # Also available if needed
...
problem = fem.petsc.LinearProblem(
    ...
    petsc_options_prefix="elasticity_"  # Required in v0.10
)
problem.solve()
# -
...
# +
ur = u.sub(0).collapse()
ur_FEM = ur.x.array[bottom_dofsx]
...
# # Pad with zeros for third component (theta direction = 0 for axisymmetric)
...
# # displacement_3d[:, 2] remains 0 (theta component)
...
# plotter.add_mesh(grid, style="wireframe", color="black", opacity=0.3, label="Original")
# plotter.add_mesh(warped, show_edges=True, color="lightblue", label="Deformed")
# plotter.camera_position = 'xy'
# plotter.screenshot('deformation.png', window_size=[1920, 1080])
# print("✓ Saved deformation.png")

# # Clean up the matplotlib warning - comment out or remove plt.show()
